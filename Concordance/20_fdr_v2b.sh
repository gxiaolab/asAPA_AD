...
do
	...
	do
		outdir1=${DIR_OUT}/v2b/Control.filtered2.fisherP.$method.$pthresh
		outdir2=${DIR_OUT}/v2b/AD.filtered2.fisherP.$method.$pthresh
		...
		R CMD BATCH --no-save '--args indir="'$indir1'" padjmethod="'$method'" pthresh='$pthresh' outdir="'$outf_Control'"' ./p.adjust.R log/fisherP.adjust_r/.si.detect.non-causal.v2b.Control
		R CMD BATCH --no-save '--args indir="'$indir2'" padjmethod="'$method'" pthresh='$pthresh' outdir="'$outf_AD'"' ./p.adjust.R log/fisherP.adjust_r/.si.detect.non-causal.v2b.AD
	done
